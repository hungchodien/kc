    ...
    <div class="contents">
        <div class="profile_thumbnail">
            <div class="left_img_profile">
                <img src="<?php echo url_root;?>img/matsui_vol_1_03.jpg" alt="松井稼頭央さん" />
            </div>

        </div>
        <div class=" des_profile_vol_page">
            <p class="title_amazing_major"> 変化を恐れず夢へ邁進。 </p>
...
<div class="amazing_major_vol_page">
    <div class="contents">
        <p class="title_amazing_major"> 「これだけ練習したんだから、きっとまたやっていける。そう信じるために走り込んでいる部分もあります」</p>
        <div class="des_text_main_amazing_major">
            ...
            <p class="title_des_amazing_major"> 松井 </p>
            <p class="content_des_amazing_major">
                「怪我をしているとき、1Ａから3Ａまで、すべてのカテゴリーのマイナーチームでプレーしました。そこで学べたことは、メジャーを目指している若い選手たちは、ハングリーなのはもちろんですが、野球が大好きなんだなと。楽しげに練習しているし、少しでもいまの自分より上手くなろうと、みな必死でした。大切なのは、成功とか失敗とかいう結果よりも、野球が大好きかどうか、それだけだなと。大好きなら、どんなにしんどいことにも、耐えることができます。例えば、僕は、基本練習を大事にしています。それは他人から見れば、単調でつまらない練習に思われるかもしれませんが、僕は、基本がなければビッグプレーは生まれないと信じています。試合で一つの簡単なゴロを捕球するために、何千回、何万回とノックを受ける。そしてファインプレーができたとき、最高に気持ちいいですし、練習してきてよかったなと心から思えるんです」
            </p>
