    ...
    <div class="contents">
        <div class="profile_thumbnail">
            <div class="left_img_profile">
                <img src="<?php echo url_root;?>img/matsui_vol_1_04.jpg" alt="松井稼頭央さん" />
            </div>
        </div>
        <div class=" des_profile_vol_page">
            <p class="title_amazing_major"> 新天地で見つけた自分らしさ。 </p>
...
<div class="amazing_major_vol_page">
    <div class="contents">
        <p class="title_amazing_major"> 「本当の自分でない自分を求めてしまったら無理がある。他人にはなく、自分にはあることを大切にする」</p>
