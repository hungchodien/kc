    ...
    <div class="contents">
        <div class="profile_thumbnail">
            <div class="left_img_profile">
                <img src="<?php echo url_root;?>img/matsui_vol_1_05.jpg" alt="松井稼頭央さん" />
            </div>
        </div>
        <div class=" des_profile_vol_page">
            <p class="title_amazing_major"> メリットやデメリットを超越した向上心。 </p>
...
<div class="amazing_major_vol_page">
    <div class="contents">
        <p class="title_amazing_major"> 「選択した時点で悔いがない以上、結果がどうあれその選択は成功だと思いたい」</p>
